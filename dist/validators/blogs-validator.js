...
exports.idParamsValidation = (0, express_validator_1.param)('id').exists().isString().trim().withMessage('Incorrect id');
...
const blogPostValidation = () => [exports.idParamsValidation, exports.nameValidation, exports.descriptionValidation, exports.websiteUrlValidation, input_model_validation_1.inputModelValidation];
